...
public class StringDigraphFactory implements GraphmlFactory {
	...
	public Object createGraph(GraphmlContext context, String id,
			String edgedefault) {
	...
	public Object createEdge(GraphmlContext context, String id, String source,
			String target, String sourceport, String targetport, String directed) {
		Digraph digraph = (Digraph) context.getGraph();
		digraph.putArc(source, target, id != null ? id : "");
		return id;
	}
	...
	public Object createEndPoint(GraphmlContext context, String id,
			String node, String port, String type) {
		return null;
	}
}